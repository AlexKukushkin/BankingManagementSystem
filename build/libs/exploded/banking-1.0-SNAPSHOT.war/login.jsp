...
<div class="container">
    <form class="form-signin" id="myForm" method="post">
        <h2 class="form-signin-heading">Регистрация клиента в банке</h2>
        ...
        <button class="btn btn-lg btn-primary btn-block" formaction="login" title=value="login" type="submit">
